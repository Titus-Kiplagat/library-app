...
# 📖 Library App <a name="about-project"></a>

**Library app** is a tool that allows a user to record what books are in the library and who borrows them.
...
```
cd my-folder
git clone git@github.com:Titus-Kiplagat/library-app.git
```
